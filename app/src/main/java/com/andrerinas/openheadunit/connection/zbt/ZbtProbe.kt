...
object ZbtProbe {
     ...
     *
     * The same message the wireless handshake opens with, built from the same generated type and the
     * same framing, so a reply proves the whole path rather than just this class. Nothing here
     * duplicates `WppFraming`; if it did, the probe could pass while the real transport failed.
     */
