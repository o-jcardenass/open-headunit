...
| `audio-sink-jitter` | **QUEUED (round 3)** | round3-brief.md against `fix/audio-sink-and-wireless-bring-up` `02ce29d0`, gate 1947/0. The branch was renamed and consolidated: four commits, one per component, and the three old branch names are deleted. P5 is the headline; the round's real question is what `dumpsys media.audio_flinger` says at each marker. |
