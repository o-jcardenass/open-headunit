...
- `native-aa-dsam-wifi-unavailable-round2-brief.md` (Part A is a PC desk step on D-SAM's framework; Part B needs D-SAM and D-POCO)
...
| `native-aa-dsam-wifi-unavailable` | **QUEUED** | native-aa-dsam-wifi-unavailable-round2-brief.md. D-SAM's platform deletes the group when the phone's first join try leaves it; A reads Samsung's rule, B tests `5846b249`. |
