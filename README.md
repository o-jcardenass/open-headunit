...
| `hold-aa-rfcomm` | **DONE, round 1** | `hold-aa-rfcomm-round1-results.md` on `c3c5a2d8`. No FAIL. Retry fully suppressed (61 WPP restarts/5min control vs 0/677s candidate); R2's ping-answered counter stuck at 0 (flagged, likely a GH quirk not a bug); R3-R6 all PASS. |
