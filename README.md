...
| `hold-aa-rfcomm` | **DONE, round 1** | `hold-aa-rfcomm-round1-results.md` on `c3c5a2d8`, no FAIL, retry fully suppressed. Addendum `hold-aa-rfcomm-round1-addendum-standin-hfp-bt-coexistence.md`: D-SAM's stand-in HFP dies on an incoming call unless its own BT is off. |
